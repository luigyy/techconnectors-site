    ...
    <div className="">
      <div className="red-dotted-bg h-[50vh] overflow-hidden px-4 md:px-32">
        <h1 className=" mt-20 rounded-xl bg-white bg-opacity-70 py-6 text-center text-3xl font-semibold">
          ...
          obcaecati porro accusamus sapiente, dignissimos quaerat assumenda esse
          nihil alias necessitatibus perferendis animi placeat itaque saepe
          libero suscipit. Aliquam in, rerum repellat nemo assumenda vero
          tempore quam unde deserunt odio quisquam.
        </h1>
      </div>
      <div className="px-4 py-16 md:px-32">
        <h1 className="text-center font-fjalla text-3xl">ReferScout</h1>
